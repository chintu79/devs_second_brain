    ...
    >
      ...
      {editing ? (
        ...
        <>
          ...
          <div className="fixed bottom-0 w-[100%] border-t border-border/30 bg-background px-5 py-3 flex items-center justify-between gap-2">
            <div className="flex gap-2">
              <Button onClick={handleCopy} variant="default" size="sm" className="h-8 text-xs gap-1.5">
                <Copy className="h-3.5 w-3.5" />
                {copied ? "Copied!" : "Copy"}
              </Button>
              <Button onClick={() => setEditing(true)} variant="outline" size="sm" className="h-8 text-xs gap-1.5">
                <Pencil className="h-3.5 w-3.5" />
                Edit
              </Button>
            </div>
            ...
            <button
              ...
              disabled={deleting}
              className="flex h-8 items-center gap-1.5 rounded-md px-2.5 text-xs text-destructive hover:bg-destructive/10 transition-colors"
            >
...
function EditForm({
  ...
  return (
    <form action={onSave} className="p-6 space-y-4">
      ...
      <div className="fixed bottom-0 bg-background w-[100%] flex items-center justify-between gap-2 pt-2">
